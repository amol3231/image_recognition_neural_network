...
abstract class NeuralNet
{
    ...
    void error(int i)
    {
        ...
        case 100: // 'd'
            ...
            s1 = "The amount of values in one row must be: value in second line + value in third l" +
"ine + 1."
;
            break;

        case 106: // 'j'
            s = "The number of input values in the specified pattern file is not the same as the " +
"number of neurons in the input neuron layer."
;
            s1 = "Set the value in the second line of your pattern file to the number of input neu" +
"rons or change the number of neurons in the input layer."
;
            break;

        case 107: // 'k'
            s = "The number of target values in the specified pattern file is not the same as the" +
" number of neurons in the output neuron layer."
;
            s1 = "Set the value in the third line of your pattern file to the number of output neu" +
"rons."
;
            break;
        ...
        case 102: // 'f'
            s = "The number of patterns in the specified pattern file does not match the given nu" +
"mber."
;
        ...
        case 108: // 'l'
            ...
            s1 = "Increase the value of the maximum learning cycles or set it to -1 if the net sho" +
"uld learn infinitely."
;
            break;
        }
